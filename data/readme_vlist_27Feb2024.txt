...
Missing OFCL forecasts at 60, 84 and 108 filled in with time interpolation. 
...
SPDX       The average eastward-component of the TC motion vector (kt) from the DSHIPS track forecast averaged over the 24 h period up to the forecast time 
...
ESGX       Standard deviation of ensemble member displacements from the ensemble mean in the east-west direction (km)
ESGY       Standard deviation of ensemble member displacements from the ensemble mean in the north-south direction (km)
ERXY       Correlation of ESGX and ESGY
ESRD       Average distance of the ensemble members from the ensemble mean (kt)
ENUM       Number of ensemble members with a valid forecast (some members drop out before the end of the forecast)
