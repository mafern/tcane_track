...
def get_mv_normal(y_data):
    mu_u,mu_v,sigma_u,sigma_v,rho = (y_data[0],
                                     y_data[1],
                                     y_data[2],
                                     y_data[3],
                                     y_data[4],
...
#     error_vec = np.zeros((y_data.shape[0],2))
#     for isample in np.arange(0,y_data.shape[0]):
#         mu_u,mu_v,sigma_u,sigma_v,rho = (y_data[isample,0],
#                                          y_data[isample,1],
#                                          y_data[isample,2],
#                                          y_data[isample,3],
#                                          y_data[isample,4],
...
#     # perc_improve = 100*(rmse.mean()-rmse_cons.mean())/rmse_cons.mean()
#     # print('    ' + str(perc_improve.round(2)) + '%') # negative implies improvement
